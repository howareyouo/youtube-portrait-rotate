...
pbtn.innerHTML = '<svg viewBox="0 0 1024 1024"><path d="M768 768V256a85.333333 85.333333 0 0 0-85.333333-85.333333H341.333333a85.333333 85.333333 0 0 0-85.333333 85.333333v512a85.333333 85.333333 0 0 0 85.333333 85.333333h341.333334a85.333333 85.333333 0 0 0 85.333333-85.333333z m128 0a42.666667 42.666667 0 0 0 42.666667-42.666667V298.666667a42.666667 42.666667 0 0 0-42.666667-42.666667h-42.666667v512zM128 256a42.666667 42.666667 0 0 0-42.666667 42.666667v426.666666a42.666667 42.666667 0 0 0 42.666667 42.666667h42.666667V256z"/></svg>'
pbtn.className = 'ytp-button ytp-custom-button'
...
var keyCodes = {a: 37, d: 39, w: 38, s: 40}, isVR
...
function keydown (e) {
  ...
  switch (key) {
    ...
    case 'w':
    case 's':
      !isVR && player.dispatchEvent(new KeyboardEvent('keydown', {keyCode: keyCodes[key]}))
  }
}
...
if (ctrls) {
  ...
  isVR = player.querySelector('canvas')
